...
<body>
    <div class="template-base">
        <nav class="br-skiplink" role="menubar"><a class="br-item" href="#main-content" role="menuitem"
                accesskey="1">Ir para o conteúdo <span aria-hidden="true">(1/4)</span> <span aria-hidden="true"
                        ...
                        <div class="menu-container">
                            <div class="menu-panel">
                                ...
                                <nav class="menu-body" role="tree">
                                            ...
                                            <li><a class="menu-item" href="javascript: void(0)" role="treeitem"><span
                                                ...
                                                <ul>
                                                    <li><a class="menu-item" href="javascript: void(0)"
                                                            role="treeitem"><span class="icon"><i
                                                                    class="fas fa-book"
                                    ...
                                    </div><a class="menu-item divider" href="javascript: void(0)"
                                        role="treeitem"><span class="icon"><i class="fas fa-bell"
                                ...
                                <div class="menu-footer">
                                    ...
                                    <div class="menu-links"><a href="javascript: void(0)"><span class="mr-1">Link
                                                ...
                                                class="fas fa-external-link-square-alt" aria-hidden="true"></i></a>
                                    </div>
                        ...
                        <nav class="br-breadcrumb">
                            <ol class="crumb-list" role="list">
                                ...
                                <li class="crumb" data-active="active"><i
                                        class="icon fas fa-chevron-right"></i><span tabindex="0"
                                        aria-current="page">Tela Atual</span>
                                </li>
                            </ol>
                        </nav>
                                        ...
                                        <div class="row">
                                            <div class="col-md-7 mb-3">
                                                <div class="br-input"><label for="name">Nome</label>
                                                    <input id="name" value="Fulano (input preenchido)"
                                                        type="text" />
                                                </div>
                                            </div>
                                            <div class="col-md-7 mb-3">
                                            ...
                                            <div class="col-md-7 mb-3">
                                                <div class="br-input input-button">
                                                    ...
                                                    <button class="br-button" type="button"
                                                        aria-label="Exibir senha" role="switch"
                                                        aria-checked="false"><i class="fas fa-eye"
                                                            aria-hidden="true"></i>
                                                    </button>
                                                </div>
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm d-flex">
                                    <div class="br-card">
                                        ...
                                        <div class="card-content">Lorem ipsum dolor sit amet consectetur, adipisicing
                                            elit. Ducimus dignissimos, recusandae at accusamus autem error hic adipisci
                                            eligendi eum debitis dolores magnam quod sint doloribus omnis vitae placeat.
                                            Natus, minus.</div>
                                    </div>
                                </div>
                                <div class="col-sm d-flex">
                                    <div class="br-card">
                                        ...
                                        <div class="card-content">Lorem ipsum dolor, sit amet consectetur adipisicing
                                            elit. Veritatis culpa inventore mollitia vitae a nesciunt reiciendis
                                            incidunt, labore repudiandae voluptate nisi. Numquam illo est maiores
                                            doloribus recusandae rem inventore ea?</div>
                                    </div>
                                </div>
                                <div class="col-sm d-flex">
                                    <div class="br-card">
                                        ...
                                        <div class="card-content">Lorem ipsum, dolor sit amet consectetur adipisicing
                                            elit. Laboriosam cupiditate nihil facere autem dignissimos ex beatae labore?
                                            Fuga consequuntur consectetur voluptatum incidunt, tenetur, dolore magnam
                                            inventore hic iusto amet ipsa.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
